...
public class SaveLoadMenu : MonoBehaviour {
	...
	void OnGUI() {
		...
		if(showMenu == true) {
			...
			if(GUILayout.Button("Cikis")) {
				Application.Quit();
				return;
			}
			
			if(GUILayout.Button("Kayit et")) {
				
				SaveGame();
				return;
			}
			
			if(GUILayout.Button("Yukle")) {
				LoadGame();
				return;
			}
	...
	public void ClearScene() {
		...
		foreach (object o in obj) {
			...
			if(go.CompareTag("DontDestroy") || go.CompareTag("Left") || go.CompareTag("MainCamera") || go.CompareTag("Floor") || go.CompareTag("TopLeft") || go.CompareTag("TopRight")
                || go.CompareTag("BotLeft") || go.CompareTag("BotRight") || go.CompareTag("Bot") || go.CompareTag("Right") || go.CompareTag("Top") || go.CompareTag("Top_D")
                || go.CompareTag("Bot_D") || go.CompareTag("Left_D") || go.CompareTag("Right_D") || go.CompareTag("Bot_D") || go.CompareTag("BotLeft_D") || go.CompareTag("BotRight_D")
                || go.CompareTag("TopLeft_D") || go.CompareTag("TopRight_D") || go.CompareTag("Placed") || go.CompareTag("ReadyForPlace") || go.CompareTag("ControlGame"))  {
